                ...
                <ul className="absolute right-0 top-full flex flex-col bg-gray-100 z-20 w-[220px]">
                  ...
                  {isUserLoggedIn && (
                    <>
                      ...
                      {role === "admin" && (
                        <>
                          <Link onClick={openMenuHnadler} className={"px-4 py-2 hover:bg-slate-500 hover:text-white "} to={"/users"}>
                            <i className="fa-solid fa-plus mr-2"></i> Visi vartotojai
                          </Link>
                          <Link onClick={openMenuHnadler} className={"px-4 py-2 hover:bg-slate-500 hover:text-white "} to={"/categories"}>
                            <i className="fa-solid fa-plus mr-2"></i> Kategorijos
                          </Link>
                        </>
                      )}

                      <Link onClick={openMenuHnadler} className={"px-4 py-2 hover:bg-slate-500 hover:text-white "} to={"/add"}>
                        <i className="fa-solid fa-plus mr-2"></i> Pridėti skelbimą
                      </Link>
